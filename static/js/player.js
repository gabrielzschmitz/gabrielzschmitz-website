 ...
 * ./music/playlist.json (generated by build.sh from
 * static/music/*.mp3).
 */
document.addEventListener('DOMContentLoaded', () => {
  ...
  function setTrackInfo() {
    ...
    if (creditEl) {
      const link = '<a href="https://github.com/gabrielzschmitz/gabrielzschmitz-website/tree/main/scripts/ATTRIBUTION.md">' +
