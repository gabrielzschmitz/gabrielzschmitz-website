#!/usr/bin/env python3
"""Generate Zola art pages from scripts/art.json.

The JSON file is the single source of truth for the art gallery (same pattern
as the music playlist's scripts/credits.json). For every entry in
...
META = ROOT / "scripts" / "art.json"
ART_DIR = ROOT / "static" / "art"
OUT_DIR = ROOT / "content" / "art"

GENERATED = "# generated by scripts/generate_art.py; edit scripts/art.json"
