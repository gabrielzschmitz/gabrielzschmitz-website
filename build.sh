...
print_banner() {
  ...
  echo -e "       ${BOLD}${BLACK}${BG_RED}|     ${RESET}${BOLD}${WHITE}${BG_RED}█░${RESET}${BOLD}${BLACK}${BG_RED}                |${RESET}"
  echo -e "       ${BOLD}${BLACK}${BG_RED}|     ${RESET}${BOLD}${WHITE}${BG_RED}█░${RESET}${BOLD}${BLACK}${BG_RED} ${RESET}${BOLD}${WHITE}${BG_RED}▓█${RESET}${BOLD}${BLACK}${BG_RED}             |${RESET}"
  echo -e "       ${BOLD}${BLACK}${BG_RED}|      ${RESET}${BOLD}${WHITE}${BG_RED}█▓▒░${RESET}${BOLD}${BLACK}${BG_RED}             |${RESET}"
  echo -e "       ${BOLD}${BLACK}${BG_RED}|           ${RESET}${BOLD}${WHITE}${BG_RED}█▓▒░${RESET}${BOLD}${BLACK}${BG_RED}        |${RESET}"
  echo -e "       ${BOLD}${BLACK}${BG_RED}|             ${RESET}${BOLD}${WHITE}${BG_RED}▓${RESET}${BOLD}${BLACK}${BG_RED}         |${RESET}"
  echo -e "       ${BOLD}${BLACK}${BG_RED}|            ${RESET}${BOLD}${WHITE}${BG_RED}▒${RESET}${BOLD}${BLACK}${BG_RED}          |${RESET}"
...
for arg in "$@"; do
  case "$arg" in
    ...
    --help|-h)
      ...
      echo "                     shots: /=screenshots/website-demo.png /blog=screenshots/blog-demo.png /research=screenshots/research-demo.png /art=screenshots/art-demo.png"
